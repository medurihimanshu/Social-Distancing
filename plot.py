...
def social_distancing_view(frame, distances_mat, boxes, risk_count):
    ...
    pad = np.full((140,frame.shape[1],3), [220, 220, 220], dtype=np.uint8)
    cv2.putText(pad, "---DETECTION STATISTICS---", (50, 30),cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 0), 2)
    cv2.putText(pad, "-- HIGH RISK : " + str(risk_count[0]) + " people", (50, 70), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 255), 2)
    cv2.putText(pad, "-- LOW RISK : " + str(risk_count[1]) + " people", (50, 95), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (100, 200, 200), 2)
    cv2.putText(pad, "-- SAFE : " + str(risk_count[2]) + " people", (50,  120), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (100, 100, 0), 2)
